...
import com.example.shearemeal.databinding.ActivityLocationmodifyBinding
...
class LocationmodifyActivity : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var binding: ActivityLocationmodifyBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLocationmodifyBinding.inflate(layoutInflater)
        ...
        binding.doneBtn.setOnClickListener {
            if (::currentLocation.isInitialized) {
                ...
                intent.putExtra("addressedit", address)
                intent.putExtra("latitudeedit", currentLocation.latitude)
                intent.putExtra("longitudeedit", currentLocation.longitude)
